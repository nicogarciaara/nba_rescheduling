                                            ...
                                            for overlap_tours in [False]:
                                                ...
                                                for s in range(len(starts)):
                                                    ...
                                                    print(f"Rescheduling matches for league {league} - objective {objective},  "
                                                          ...
                                                          f"- max mods per tour {max_mods_per_tour} - feasibility days {feasibility_days} - OverlapTours {overlap_tours}")
